...
app.use(plugin, defaultConfig({
    config: {
        classes: generateClasses({
            ...
            button: {
                wrapper: 'mb-1',
                input: 'bg-indigo-700 hover:bg-purple-500 text-white text-sm font-normal py-2 px-3 rounded'
            },
            color: {
            ...
            checkbox: {
                ...
                input: 'form-check-input appearance-none h-4 w-4 mr-1 border border-gray-500 rounded-sm bg-white checked:bg-cyan-500 focus:outline-none focus:ring-0 transition duration-200',
            ...
            radio: {
                legend: 'font-bold text-sm pb-3',
                wrapper: 'flex mb-1 cursor-pointer',
                input: 'form-check-input appearance-none h-4 w-4 mr-1 border border-gray-500 rounded-full bg-transparent checked:bg-indigo-500 focus:outline-none focus:ring-0 transition duration-200',
